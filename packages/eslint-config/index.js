...
const unusedImportsPluginConfig = {
  plugins: {
...
export const jsFiles = ["**/*.{js,jsx,cjs,mjs}"];
export const tsFiles = ["**/*.{ts,tsx,cts,mts}"];
export const allSourceFiles = [...jsFiles, ...tsFiles];

export const createTsParser = (rootDir, project) => ({
...
export const createTsConfig = (rootDir, project) => [
  {
    languageOptions: createTsParser(rootDir, project),
    settings: {
